...
/* =========================================================
   ...
   Flow: form -> /api/demo-session (optional Firecrawl scrape of their site +
   personalised prompt + signed URL for the shared private agent) ->
   ElevenLabs WebRTC session in the browser via mic.

   The agent id + API keys never touch the client; the serverless function is
   the only thing that can mint a session, and it rate-limits per IP.
   ========================================================= */
